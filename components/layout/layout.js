...
function createNewColumnElement() {
  ...
  // Set class attribute
  divElement.setAttribute('class', 'toggle-modal-button w-280 h-fit mt-9 flex rounded-md bg-gradient-primary cursor-pointer items-center content-center overflow-visible p-5')
